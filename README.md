...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/Tests-605%20passing-brightgreen" alt="605 tests">
...
- **100% test coverage** — 605 unit + e2e tests, enforced in CI with `--cov-fail-under=100`
...
| Testing | pytest (605 tests, 100% coverage), Playwright (e2e smoke) |
