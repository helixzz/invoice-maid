...
<p align="center">
  <img src="https://img.shields.io/badge/version-0.9.0--alpha.6-blue" alt="v0.9.0-alpha.6">
  ...
  <img src="https://img.shields.io/badge/Tests-556%20passing-brightgreen" alt="556 tests">
...
- **100% test coverage** — 556 unit + e2e tests, enforced in CI with `--cov-fail-under=100`
...
| Testing | pytest (556 tests, 100% coverage), Playwright (e2e smoke) |
