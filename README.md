...
<p align="center">
  <img src="https://img.shields.io/badge/version-0.9.0--alpha.7.post1-blue" alt="v0.9.0-alpha.7.post1">
  ...
  <img src="https://img.shields.io/badge/Tests-571%20passing-brightgreen" alt="571 tests">
...
- **100% test coverage** — 571 unit + e2e tests, enforced in CI with `--cov-fail-under=100`
...
| Testing | pytest (571 tests, 100% coverage), Playwright (e2e smoke) |
