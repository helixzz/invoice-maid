...
<p align="center">
  <img src="https://img.shields.io/badge/version-0.9.0--alpha.8-blue" alt="v0.9.0-alpha.8">
  ...
  <img src="https://img.shields.io/badge/Tests-584%20passing-brightgreen" alt="584 tests">
...
- **100% test coverage** — 584 unit + e2e tests, enforced in CI with `--cov-fail-under=100`
...
| Testing | pytest (584 tests, 100% coverage), Playwright (e2e smoke) |
