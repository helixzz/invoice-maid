...
class EmailAccount(Base):
    ...
    playwright_storage_state: Mapped[str | None] = mapped_column(Text(), nullable=True)
    secondary_credential_encrypted: Mapped[str | None] = mapped_column(Text(), nullable=True)
    secondary_password_encrypted: Mapped[str | None] = mapped_column(Text(), nullable=True)
